...
public class ApiAuthenticationHandler : DelegatingHandler
{
    ...
    public ApiAuthenticationHandler(ILocalStorageService localStorage, AuthenticationStateProvider authenticationStateProvider, NavigationManager navigationManager)
    {
