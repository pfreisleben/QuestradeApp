...
namespace AuthenticationApi.Infrastructure.Identity.Helpers
{
            ...
            foreach (var module in modules)
            {
                ...
                foreach (var fi in fields)
                {
                    ...
                    if (propertyValue is not null)
                        ...
                        {
                            Value = propertyValue.ToString(), Type = ApplicationClaimTypes.Permission,
                            Group = moduleName, Description = moduleDescription
                        });
                }
            }
        }

        public static async Task<IdentityResult> AddPermissionClaim(this RoleManager<AppRole> roleManager, AppRole role,
            string permission)
        {
